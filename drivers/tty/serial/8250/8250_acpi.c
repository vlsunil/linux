 ...
 * 8250 framework for reset of the functionality.
 */
...
module_platform_driver(acpi_platform_serial_driver);

MODULE_AUTHOR("Sunil V L <sunilvl@ventanamicro.com>");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Serial Port Driver for ACPI platform devices");
